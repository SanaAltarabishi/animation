import 'package:animation/title_screen/particule_overlay.dart';
...
Positioned.fill(child:IgnorePointer(child: ParticleOverlay(color: orbColor, energy:_orbEnergy),)),
                    ...
                    /*The difference between _LitImage and Image.asset is that _LitImage is a custom widget 
            that extends StatelessWidget and allows for more customization and control over the displayed image.*/
